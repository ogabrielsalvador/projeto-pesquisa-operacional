...
def jujuba(arq_instancia):
    ...
    dist_total = 0
    print(f'\nEsse é o arquivo {arq_instancia}\n')
    for n in range(1, qtde_quadrantes + 1):
        ...
        solucao_quad, dist_total_quad = vmp(mat_dist, coordenadas)
        dist_total += dist_total_quad
        ...
        print('-' * 50)
    print(f'A menor distancia total da instancia é {dist_total}')
    print('=' * 50)
