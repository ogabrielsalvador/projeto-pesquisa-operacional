...
def correcao(arq_instancia, arq_solucao):
    ...
    if gap <= 20:
        print(f'\033[1;32mPERFEITO!\033[m O seu GAP foi de \033[1;32m{gap:.0f}%\033[m em comparação ao valor de referência\n')
    elif gap <= 50:
        print(f'\033[1;34mBOM!\033[m O seu GAP foi de \033[1;34m{gap}%\033[m em comparação ao valor de referência\n')
    elif gap <= 100:
        print(f'\033[1;35mQUASE!\033[m O seu GAP foi de \033[1;35m{gap}%\033[m em comparação ao valor de referência\n')
    elif gap <= 200:
        print(f'\033[1;33mRUIM!\033[m O seu GAP foi de \033[1;33m{gap}%\033[m em comparação ao valor de referência\n')
    else:
        print(f'\033[1;31mPÉSSIMO!\033[m O seu GAP foi de \033[1;31m{gap}%\033[m em comparação ao valor de referência\n')
    """
    # FIM DA CORREÇÃO
    print(f'{"=" * 65}')
